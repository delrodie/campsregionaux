 ...
 * @Route("/bognan-kokoe")
 */
class AgbovilleController extends AbstractController
{
    const region = "AGBOVILLE";
    ...
    /**
     * @Route("/", name="agboville_index", methods={"GET","POST"})
     */
    public function index(): Response
    {
        ...
        return $this->render('agboville/index.html.twig', [
            'controller_name' => 'AgbovilleController',
        ]);
    }
}
