 ...
 * @Route("/les-croisades")
 */
class OdienneController extends AbstractController
{
    const region = "ODIENNE";
    ...
    public function index(): Response
    {
        ...
        return $this->render('odienne/index.html.twig', [
            'controller_name' => 'OdienneController',
        ]);
    }
}
